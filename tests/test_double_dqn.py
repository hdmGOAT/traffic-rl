"""Unit tests for Double DQN agent."""
import numpy as np

from traffic_rl.agents.double_dqn import DoubleDQNAgent


def test_double_dqn_initialization():
...
def test_double_dqn_save_load(tmp_path):
    ...
    assert np.allclose(agent1.online_net.w2, agent2.online_net.w2)
